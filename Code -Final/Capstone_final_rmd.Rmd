...
Our current focus for our project is centered around looking into how global burden of disease is being addressed by clinical trials around the world. Different center types have different amount of funding which heavily influence there development to create a successful treatment to said cancer, with many under funded types of cancer having significant less amount of funding for research. As a result, our current research question is: How does clinical research around the world address known disease burdens? Is there sufficient research to address the health issues?

#Data sources
Include a description of the datasets you use, along with an example of the relevant fields in them, a description of how you clean them, and their relationship to each other (e.g. how they are joined).
